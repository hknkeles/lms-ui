  ...
  return (
    <div className="space-y-6">
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
        <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Mesajlar</h2>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
        <div className="space-y-4">
          <div className="flex items-start gap-4 p-4 bg-pastel-blue-light dark:bg-gray-700 rounded-lg border-l-4 border-primary-500">
            <div className="w-10 h-10 bg-primary-500 rounded-full flex items-center justify-center flex-shrink-0">
              <span className="text-white font-medium text-sm">AY</span>
            </div>
            <div className="flex-1">
              <div className="flex items-center justify-between mb-2">
                <h4 className="font-medium text-gray-900 dark:text-white">Prof. Dr. Ahmet Yılmaz</h4>
              ...
              <div className="flex gap-2">
                ...
                <button className="px-3 py-1 bg-gray-200 dark:bg-gray-600 text-gray-700 dark:text-gray-300 text-xs rounded-md hover:bg-gray-300 dark:hover:bg-gray-500 transition-colors">
                  Görüntüle
                </button>
              </div>
            </div>
          ...
          <div className="flex items-start gap-4 p-4 bg-green-50 dark:bg-green-900/20 rounded-lg border-l-4 border-green-500">
            ...
            <div className="flex-1">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-xs text-gray-500 dark:text-gray-400">1 gün önce</span>
              </div>
              <p className="text-sm text-gray-700 dark:text-gray-300 mb-2">
                Essay'ini aldım. Çok iyi yazılmış! Sadece birkaç gramer hatası var, onları düzeltebilirsin.
              </p>
              <div className="flex gap-2">
                <button className="px-3 py-1 bg-green-500 text-white text-xs rounded-md hover:bg-green-600 transition-colors">
                  Yanıtla
                </button>
                <button className="px-3 py-1 bg-gray-200 dark:bg-gray-600 text-gray-700 dark:text-gray-300 text-xs rounded-md hover:bg-gray-300 dark:hover:bg-gray-500 transition-colors">
                  Görüntüle
          ...
          <div className="flex items-start gap-4 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg border-l-4 border-gray-400">
            ...
            <div className="flex-1">
              <div className="flex items-center justify-between mb-2">
                <h4 className="font-medium text-gray-900 dark:text-white">Prof. Dr. Mehmet Kaya</h4>
                <span className="text-xs text-gray-500 dark:text-gray-400">3 gün önce</span>
              </div>
              <p className="text-sm text-gray-700 dark:text-gray-300 mb-2">
